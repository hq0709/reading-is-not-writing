...
\caption{\textbf{Mass clinical competition across prompts.} Clinical margin: the Mass effect minus the largest of the five other clinical effects, in finding-present logit units at $\alpha=+0.25$. Top: the discovery crossover (pointwise 95\% interval; largest of 20 random effects). Bottom: the registered confirmation on new patients (smallest simultaneous lower bound of the cell's five contrasts; largest of 119 random effects).}
\label{tab:seed-mass}
