...
D & Batch consistency & single- vs batched-forward answer logits within 0.25 & 0.07--1.84; above tolerance (declared, neutralised by fixed batch composition): Qwen2.5-VL ($\leq$0.37), Qwen3-VL ($\leq$1.41), InternVL3.5 ($\leq$0.48), Gemma 3 ($\leq$1.84), MedGemma ($\leq$0.56), Lingshu ($\leq$0.30), LLaVA-1.5 ($\leq$0.31), Llama 3.2 Vision ($\leq$0.41) \\
