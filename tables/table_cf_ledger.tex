...
\midrule
Write matrix, primary template & 600 test & 119 random $p_{95}$, sham & simultaneous max-$T$, 30 contrasts & the direction written & 420 \\
Probe refits, seeds 1 and 2 & 600 test & 119 random $p_{95}$, sham, the write matrix's & simultaneous max-$T$, 30 contrasts & the seed-0 normal & 840 \\
Logit-scale grade & 600 test & 119 random $p_{95}$, sham, on the margin scale & percentile interval on $O^m_q$ & the direction written & 420 \\
Unsaturated-row grade & unsaturated test & 119 random $p_{95}$, sham, on those rows & simultaneous max-$T$, 30 contrasts & the direction written & 420 \\
