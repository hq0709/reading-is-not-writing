...
\caption{\textbf{Ownership of every concept, NIH ChestX-ray14.} Each cell is the ownership contrast $O_q$ at $\alpha=+0.25$: bold is owned, a dagger marks a stronger competitor, a double dagger an unresolved verdict, and the last row counts the concept's owned cells.}
...
\scriptsize
\setlength{\tabcolsep}{4pt}
\caption{\textbf{Ownership of every concept, CheXpert Plus.} Each cell is the ownership contrast $O_q$ at $\alpha=+0.25$: bold is owned, a dagger marks a stronger competitor, a double dagger an unresolved verdict, and the last row counts the concept's owned cells.}
...
Qwen2.5-VL-72B & \cellcolor{cfTerra3}-0.12 & \cellcolor{cfSlate2}+0.09 & \cellcolor{cfSlate2}\textbf{+0.03} & \cellcolor{cfTerra3}-0.11 & \cellcolor{cfTerra4}-0.29 & \cellcolor{cfTerra3}-0.13 \\
...
CheXagent-8B & \cellcolor{cfTerra2}-0.02 & \cellcolor{cfTerra1}-0.02 & \cellcolor{cfTerra2}-0.02 & \cellcolor{cfTerra2}-0.07 & \cellcolor{cfSlate2}\textbf{+0.04} & \cellcolor{cfTerra2}-0.02 \\
...
LLaVA-Rad-7B & \cellcolor{cfTerra2}-0.04 & \cellcolor{cfTerra1}-0.01 & \cellcolor{cfSlate1}+0.00 & \cellcolor{cfTerra2}-0.07 & \cellcolor{cfSlate2}+0.02 & \cellcolor{cfTerra1}-0.00 \\
\midrule
...
\scriptsize
\setlength{\tabcolsep}{4pt}
\caption{\textbf{Ownership of every concept, COCO.} Each cell is the ownership contrast $O_q$ at $\alpha=+0.25$: bold is owned, a dagger marks a stronger competitor, a double dagger an unresolved verdict, and the last row counts the concept's owned cells.}
...
Qwen2.5-VL-72B & \cellcolor{cfSlate4}\textbf{+0.66} & \cellcolor{cfSlate4}\textbf{+0.44} & \cellcolor{cfSlate4}\textbf{+0.95} & \cellcolor{cfSlate4}\textbf{+0.89} & \cellcolor{cfSlate4}\textbf{+0.62} & \cellcolor{cfSlate4}\textbf{+0.40} \\
...
LLaVA-Rad-7B & \cellcolor{cfTerra2}-0.06 & \cellcolor{cfSlate1}+0.01 & \cellcolor{cfTerra2}-0.02 & \cellcolor{cfTerra2}-0.06 & \cellcolor{cfTerra2}-0.04 & \cellcolor{cfTerra1}-0.00 \\
\midrule
