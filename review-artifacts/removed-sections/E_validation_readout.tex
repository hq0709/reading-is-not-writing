...
Selectivity, defined in Section~\ref{app:seed}, subtracts mean control
...
intervals span zero. Effusion's larger pilot lower bound motivated its
selection for independent answer and reader validation. That follow-up
does not replicate its positive selectivity (Appendix~\ref{app:image-readout});
the pilot selection remains exploratory.
...
The pilot tables juxtapose controlled reader information and unresolved
clean answer discrimination. These criteria test different quantities;
their qualification pattern is not a direct statistical comparison.
Appendix~\ref{app:image-readout} reports the ensuing finite text calibration
and independent image/reader test. Its nonreplicated selectivity limits the
pilot pattern to this cohort rather than establishing a reproducible
separation between measurement stages.
