...
Table~\ref{tab:cf-geometry} gives the direction- and label-geometry statistics and Table~\ref{tab:cf-scale} the scale, saturation, refit, connector, and batch statistics behind Section~\ref{sec:robust-geometry}.
