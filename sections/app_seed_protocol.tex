...
The two-model study that motivated the evaluation registered the procedures below; Appendix~\ref{app:seed-results} reports its results and Appendix~\ref{app:seed-boundary} its boundary analyses.
