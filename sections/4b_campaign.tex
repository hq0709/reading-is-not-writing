...
\input{tables/table_cf_leaderboard}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/cf_F3_effusion_across_blocks.pdf}
