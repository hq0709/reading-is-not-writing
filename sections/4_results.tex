...
A registered exploratory validation screen separates frozen-reader availability from clean answer discrimination on the same 700 patients. Effusion selectivity is 0.1438 (95\% CI $[0.0658,0.2163]$), and Cardiomegaly is 0.0889 ($[0.0002,0.1723]$); both pass the reader screen. Yet none of the six fixed yes/no margins has an AUROC one-sided 95\% lower bound above 0.5; the highest is 0.4731. These are distinct measurement criteria, not a direct test of their difference. Joint reader and capability qualification admits no question, so the reserved 100-patient write cohort remains unevaluated. The screen therefore identifies readable direction-level information with unresolved discrimination at the fixed answer margin; write efficacy awaits qualification. Appendix~\ref{app:validation-readout} reports all six questions and the prospective routing rule.
