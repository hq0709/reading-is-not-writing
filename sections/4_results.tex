...
The registered ownership matrix, within-patient input closure, label-conditioned shifts, LLaVA reader and answer measurements, and the natural paired-response cohort delimit the causal and diagnostic interpretation of these seed findings; they are reported in Appendix~\ref{app:seed-boundary} and are unchanged by the campaign.
