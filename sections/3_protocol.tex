...
Because the matrix confirms neither ownership nor an alias, the registered fallback tests Consolidation on 50 fresh patients who each have one hash-selected positive and negative study. Let $\gamma_i$ be the positive-minus-negative pooled \texttt{vis.last} displacement along the train-fitted Consolidation normal. The write dose is $\alpha_i=\operatorname{clip}(\gamma_i/\overline{\lVert h_{it}\rVert},-0.25,0.25)$ on the negative study. The closure gain is the reduction in its absolute $P(\mathrm{yes})$ gap from the paired positive study. Confirmation requires a positive displacement lower bound, a concept gain above all 119 random directions and the sham, and a positive familywise lower bound against Effusion, Atelectasis, Pneumothorax, Cardiomegaly, Mass, and Nodule over 5,000 paired bootstraps.
