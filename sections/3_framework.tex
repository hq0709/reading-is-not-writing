...
\end{itemize}
The grades are defined for one direction construction, one relative dose per module with a five-point sweep, six templates, pooled consumed-token features, and one primary and one connector locus; Section~\ref{sec:robust-geometry} scores four alternative direction constructions by the same rules.
