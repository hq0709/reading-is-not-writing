...
\caption{\textbf{Cohort roles.} Rows per role with independent units in parentheses, the largest number of rows one unit contributes, and the role's use; units are patients on the chest sets and images on COCO. The bottom panel counts the units two roles of a dataset share.}
\label{tab:cf-roles}
